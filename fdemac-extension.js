(() => {
  ...
  branch.innerHTML = `
    ...
    <div class="fdex-card fdex-invite-card"><div class="fdex-head"><div><h4>分享你的专属邀请</h4><p>好友完成活动报名后，即计为有效邀请。</p></div><button class="fdex-text-btn" data-rules>活动规则</button></div><div class="fdex-invite"><input class="fdex-link" aria-label="专属邀请链接" value="${inviteUrl}" readonly><button class="fdex-btn secondary" data-copy>复制链接</button><button class="fdex-btn" data-poster>生成海报</button></div></div>
    <div class="fdex-card fdex-track-card"><div class="fdex-head"><div><h4>呼朋引猹</h4><p>邀请好友报名共学营，让集体学习的氛围助力彼此坚持与成长。</p></div><button class="fdex-text-btn" data-simulate>演示邀请 +1</button></div><div class="fdex-progress-meta"><span>当前进度 <strong><span data-invites>0</span> 人</strong></span><span data-progress-copy>下一档：双方解锁录播课程</span></div><div class="fdex-steps">${[[1,'双方解锁','录播课程','course'],[5,'额外获得','150 瓜子','guazi'],[10,'额外获得','350 瓜子','guazi'],[15,'额外获得','888 瓜子','guazi']].map(([n,a,b,kind])=>`<div class="fdex-step" data-step="${n}"><div class="fdex-node">${kind==='course'?'<img class="fdex-course-thumb" src="./assets/course-badge.png" alt="录播课程圆形徽章">':'<img src="./assets/guazi.png" alt="瓜子">'}<span>${n}<small>人</small></span></div><b>${a}<br>${b}</b><span>${n===1?'精品录播课一节':'累计达标自动发放'}</span><span class="fdex-pill">未解锁</span></div>`).join('')}</div></div>
    <div class="fdex-shelf"><div class="fdex-shelf-title"><img src="./assets/guazi.png" alt="瓜子"><div><b>瓜棚好物</b><span>用瓜子兑换观猹限定实物</span></div></div><div class="fdex-shelf-window"><div class="fdex-shelf-track"><div class="fdex-shelf-item"><img src="./assets/gua-pins.png" alt="观猹徽章"><span><b>观猹角色徽章</b><small>四款角色随机兑换</small></span></div><div class="fdex-shelf-item"><img src="./assets/gua-backpack.png" alt="观猹背包"><span><b>观猹限定背包</b><small>多隔层日常通勤款</small></span></div><div class="fdex-shelf-item"><img src="./assets/gua-sweatshirt.png" alt="观猹卫衣"><span><b>观猹角色卫衣</b><small>柔软宽松版型</small></span></div><div class="fdex-shelf-item"><img src="./assets/course-badge.png" alt="录播课程权益"><span><b>录播课程权益</b><small>共学达标即可解锁</small></span></div><div class="fdex-shelf-item"><img src="./assets/course-card.png" alt="TokenDance 白金卡"><span><b>TokenDance 白金卡</b><small>AI 创作权益支持</small></span></div><div class="fdex-shelf-item"><img src="./assets/mac-mini-official.jpg" alt="Mac mini"><span><b>Mac mini</b><small>排行榜冲榜大奖</small></span></div><div class="fdex-shelf-item"><img src="./assets/guazi.png" alt="瓜子礼包"><span><b>瓜子奖励礼包</b><small>达标自动发放到账</small></span></div><div class="fdex-shelf-item"><img src="./assets/watcha-trophy-bronze.png" alt="精选数码好礼"><span><b>精选数码好礼</b><small>键盘、耳机等福利</small></span></div></div></div><button class="fdex-shelf-btn" data-shop>去瓜棚 →</button></div>
    <div class="fdex-card fdex-rank-card"><div class="fdex-head"><div><h4>一呼百应</h4><p>用影响力说话，邀请更多好友加入共学，赢取排行榜好礼。</p></div></div><div class="fdex-prizes"><div class="fdex-subhead"><b>排行榜奖品</b></div><div class="fdex-podium-wrap"><div class="fdex-podium"><article class="fdex-podium-card top2"><small>TOP 2</small><img class="fdex-trophy-mini" src="./assets/watcha-trophy-silver.png" alt="银色猹奖杯"><b>键盘 / 耳机</b><span>数码福利支持 · ¥1,500</span></article><article class="fdex-podium-card top1"><small>TOP 1</small><img class="fdex-trophy-mini" src="./assets/watcha-trophy.png" alt="金色猹奖杯"><b>Mac mini</b><span>冲榜大奖 · ¥5,999</span></article><article class="fdex-podium-card top3"><small>TOP 3</small><img class="fdex-trophy-mini" src="./assets/watcha-trophy-bronze.png" alt="铜色猹奖杯"><b>精选数码好礼</b><span>价值 ¥500</span></article></div></div><div class="fdex-follow-prize"><b>TOP 4–10</b><span>TokenDance 白金卡</span></div></div><div class="fdex-board"><div class="fdex-subhead"><b>实时排名</b><button class="fdex-text-btn" data-refresh>刷新排名</button></div>${rows.map(([r,a,n,c])=>`<div class="fdex-row"><span class="fdex-rank">${r}</span><span class="fdex-person"><img class="fdex-avatar" src="./assets/avatars/${a}.svg" alt="${n}的头像"><b>${n}</b></span><span class="fdex-count">${c} 人</span></div>`).join('')}<div class="fdex-me"><span>你的排名：<strong data-rank>尚未入榜</strong></span><span data-board-gap>再邀请 15 人即可入榜</span></div></div><details class="fdex-rules" data-rules-box><summary>活动规则说明（含两种拉新形式）</summary><div class="fdex-rule-grid"><p><b>呼朋引猹</b>好友通过你的专属链接完成活动报名，即为有效邀请。阶梯奖励累计解锁，瓜子与课程权益将在达标后自动发放。</p><p><b>一呼百应</b>排行榜按有效邀请人数实时更新；每位用户仅计入一位邀请人，最终名次及获奖资格以活动结束后的平台核验结果为准。</p></div></details></div>`;
  ...
  const update=()=>{document.querySelectorAll('[data-invites]').forEach(el=>el.textContent=invites);const rank=invites>=15?'第 10 名':'未上榜';document.querySelectorAll('[data-rank]').forEach(el=>el.textContent=rank);const next=[1,5,10,15].find(n=>n>invites);branch.querySelector('[data-progress-copy]').textContent=next?`下一档：${next===1?'双方解锁录播课程':next===5?'150 瓜子':next===10?'350 瓜子':'888 瓜子'}`:'全部阶梯奖励已解锁';branch.querySelector('[data-board-gap]').textContent=invites>=15?'继续邀请，向更高排名冲刺':`再邀请 ${15-invites} 人即可入榜`;branch.querySelectorAll('[data-step]').forEach(el=>{const done=invites>=+el.dataset.step;el.classList.toggle('done',done);el.querySelector('.fdex-pill').textContent=done?'已解锁':`还差 ${+el.dataset.step-invites} 人`})};
  ...
  branch.querySelector('[data-simulate]').onclick=()=>{invites=invites<1?1:invites<5?5:invites<10?10:15;update();say('已切换到下一档演示状态')};
